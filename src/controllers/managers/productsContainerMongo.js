...
class productsContainerMongo{
    ...
    async updateById(id, producto){
        try{
            this.model.updateOne({_id : id}, {$set: {"title": producto.title, "thumbnail": producto.thumbnail, "price": producto.price, "code": producto.code, "description": producto.description, "stock": producto.stock}});
